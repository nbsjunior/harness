...
Product name is now **Todd of AIDLC** (formerly Harness / ToddSpect). CLI command `todd`, workspace `.toddspect/`, and VS Code settings `toddspect.*` are unchanged.
